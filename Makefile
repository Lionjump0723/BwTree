...
CXX = g++-5
PAPI_FLAG = -lpapi
CXX_FLAG = -pthread -std=c++11 -g -Wall -mcx16 -Wno-invalid-offsetof -DNO_USE_PAPI # $(PAPI_FLAG)
GMON_FLAG = 
OPT_FLAG = -O2
PRELOAD_LIB = #LD_PRELOAD=./lib/libjemalloc.so
...
./build/skiplist.o:
	$(CXX) ./benchmark/skiplist/skiplist.cc -c -o ./build/skiplist.o $(CXX_FLAG) $(OPT_FLAG) $(GMON_FLAG)
...
generate: generate_email
	./generate_email --key-num 250000 --key-length 100 --key-type random --filename emails_dump.txt
